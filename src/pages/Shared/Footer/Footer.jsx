...
const Footer = () => {
    return (
        <footer>
            <div className="footer p-10 bg-cyan-300 font-bold text-white">
                <div>
                    <img className='w-20 h-20' src={logo1} alt="" />
                    <p><span className='text-2xl'>WeKiddies</span><br />Providing reliable services since 2002</p>
                </div>
                <div>
            ...
            <div className="footer footer-center bg-cyan-300 p-4 font-medium text-white">
                <div>
                    <p>Copyright © 2023 - All right reserved by WeKiddies</p>
                </div>
            </div>
        </footer>
    );
